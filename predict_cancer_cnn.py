...
#Hiển thị 3 loại ảnh siêu âm(actual, mask, overlayed) của lớp malignant
...
# #Hiển thị 3 loại ảnh siêu âm(actual, mask, overlayed) của lớp normal
input_dir = '/content/Dataset_BUSI_with_GT'
...
# import torch.nn as nn
# 
# # Tải mô hình ResNet-50 đã huấn luyện và fine-tuned
# # Bạn cần tải lại mô hình của bạn đã lưu trữ trước đó
# # Ví dụ: model = torch.load("resnet50_fineTuning.pth")
# model = models.resnet50(weights=models.ResNet50_Weights.IMAGENET1K_V1)
# num_ftrs = model.fc.in_features
# model.fc = nn.Linear(num_ftrs, 3)  # Thay đổi số lượng lớp đầu ra tùy thuộc vào số lớp của bạn
# 
# # Đặt mô hình vào chế độ đánh giá
# model.eval()
# 
...
# st.title("Ứng dụng Phân loại Ảnh Sử dụng ResNet-50")
# 
# # Tạo một phần để tải lên ảnh
# uploaded_file = st.file_uploader("Chọn một ảnh...", type="jpg")
# 
...
# 
#     # Hiển thị kết quả
#     labels = ['benign', 'malignant', 'normal']  # Thay đổi nhãn tùy thuộc vào lớp của bạn
